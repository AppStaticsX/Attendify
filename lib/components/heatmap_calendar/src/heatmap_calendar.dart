...
class HeatMapCalendar extends StatefulWidget {
  ...
  /// dynamically based on highest value of [datasets].
  ...
  ///
  /// Parameter gives [DateTime] value of current month.
...
class _HeatMapCalendar extends State<HeatMapCalendar> {
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Padding(
            ...
            child: Text(
              '${DateUtil.MONTH_LABEL[_currentDate?.month ?? 0]} ${_currentDate?.year}'.toUpperCase(),
              style: TextStyle(
  ...
  Widget _weekLabel() {
    return Row(
      ...
      children: DateUtil.WEEK_LABEL.skip(1).map((day) {
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                color: widget.weekTextColor ??
                    (day['color'] == 'red' ? Colors.red : const Color(0xFF758EA1)),
              ),
            ),
          ),
        );
